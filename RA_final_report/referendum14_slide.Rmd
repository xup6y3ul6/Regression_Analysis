...
- adjust R2、Mallows’s CP、AIC、BIC、PRESS
...
$$
\begin{align}
\left(Agree\_rate\right) = \color{blue}{3.60}-0.19\left(Vote\right)\color{#ff6347}{-0.28\left(Gender\right)-0.05\left(Age\right)}-3.44\left(Married\right) \\
